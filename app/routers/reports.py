...
from app.schemas.report import HealthReportResponse, ReportGenerateRequest, ReportListResponse
...
async def generate_report_endpoint(
	...
	report = await generate_report(db=db, model_id=model_id, week_start=week_start, week_end=week_end)
