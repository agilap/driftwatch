...
async def generate_report(
	...
	output_drift = float(output_row.psi) if output_row and output_row.psi is not None else None
	...
	correlation = compute_correlation(feature_drift=feature_drift, output_drift=output_drift)
...
async def list_reports_for_model(db: AsyncSession, model_id: UUID) -> list[HealthReport]:
...
async def get_latest_report_for_model(db: AsyncSession, model_id: UUID) -> HealthReport | None:
